...
function TopBar() {
  return (
    <div className="hidden h-9 items-center justify-center bg-[#1F0318] border-b border-white/[0.04] md:flex">
      <div className="flex w-full max-w-7xl items-center justify-between px-4">
        <div className="flex items-center gap-5">
          <a
            href="mailto:tradingocare@gmail.com"
            className="group flex items-center gap-1.5 text-[11px] font-medium tracking-wide text-white/45 transition-colors duration-200 hover:text-[#FF4D00]"
          >
            <Mail className="h-3 w-3 text-white/30 group-hover:text-[#FF4D00] transition-colors duration-200" />
            <span>GoConect</span>
            <span className="text-white/25 mx-1">/</span>
            <span className="text-white/35 group-hover:text-white/60 transition-colors duration-200">
          ...
          <a
            ...
            className="group flex items-center gap-1.5 text-[11px] font-medium tracking-wide text-white/45 transition-colors duration-200 hover:text-[#FF4D00]"
          >
            <Phone className="h-3 w-3 text-white/30 group-hover:text-[#FF4D00] transition-colors duration-200" />
            <span>Goquary</span>
            <span className="text-white/25 mx-1">/</span>
            <span className="text-white/35 group-hover:text-white/60 transition-colors duration-200">
              +91 99999-88888
        ...
        <div className="flex items-center gap-1">
          <span className="text-[10px] font-medium uppercase tracking-[0.18em] text-white/25 mr-2">
            GoSocial
          </span>
          ...
          {socialLinks.map(({ href, label, icon: Icon }) => (
            <a
              ...
              aria-label={label}
              className="flex h-7 w-7 items-center justify-center rounded-full text-white/30 transition-all duration-200 hover:bg-white/[0.06] hover:text-[#FF4D00] hover:scale-110"
            >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed left-3 right-3 top-20 z-40 mx-auto max-w-7xl overflow-hidden rounded-2xl border border-white/[0.08] bg-[#1F0318]/95 backdrop-blur-[30px] p-2 shadow-[0_15px_50px_rgba(0,0,0,0.55)] md:hidden"
          >
