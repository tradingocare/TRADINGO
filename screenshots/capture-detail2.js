...
(async () => {
  ...
  const detailText = await page.evaluate(() => document.body.innerText.substring(0, 5000));
  console.log(detailText);
  await page.screenshot({ path: 'E:/tradingo/screenshots/product-detail-fixed.png', fullPage: true });
  ...
  await page.screenshot({ path: 'E:/tradingo/screenshots/products-listing-fixed.png', fullPage: true });
