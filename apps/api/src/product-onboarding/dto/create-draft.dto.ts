...
export class DraftSpecDto {
  @IsString() key: string;
  @IsString() value: string;
  @IsOptional() @IsNumber() sortOrder?: number;
}

export class DraftVariantDto {
...
export class DraftCertificationDto {
  @IsString() type: string;
...
export class DraftMultiLangDescDto {
...
export class DraftPriceSlabDto {
