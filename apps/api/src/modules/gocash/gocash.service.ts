...
export class GocashService {
  ...
  async adminGetWalletStats() {
    ...
    return {
      ...
      totalBalance: Number(stats._sum.currentBalance ?? 0),
      totalAvailable: Number(stats._sum.availableBalance ?? 0),
      totalLocked: Number(stats._sum.lockedBalance ?? 0),
      totalLifetimeEarned: Number(stats._sum.lifetimeEarned ?? 0),
      totalLifetimeRedeemed: Number(stats._sum.lifetimeRedeemed ?? 0),
