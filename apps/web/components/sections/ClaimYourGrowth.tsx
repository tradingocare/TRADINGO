    ...
    <section className="relative overflow-hidden py-14 sm:py-16 lg:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-4 text-center">
        <div className="glass-panel-prism p-6 sm:p-10">
          ...
          <p className="mx-auto mt-4 max-w-4xl text-base font-semibold leading-relaxed text-accent-500 sm:text-lg">
          ...
          <p className="mx-auto mt-4 text-base font-semibold text-text-primary sm:text-lg">
            Start trading smarter. Build trusted connections. Grow without limits.
          </p>
          <p className="mx-auto mt-2 text-xs font-bold text-accent-500 drop-shadow-[0_0_10px_rgba(255,77,0,0.2)] sm:text-sm">
            {'\uD83D\uDE80'} Join Free Today and Turn Every Opportunity into Business Growth.
          </p>

          <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-[11px] font-medium text-text-tertiary sm:text-xs">
