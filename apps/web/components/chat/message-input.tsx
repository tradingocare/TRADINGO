...
export function MessageInput({ onSend, onTyping, onFileUpload }: MessageInputProps) {
 ...
 {mentionOpen && (
 <div className="max-h-32 overflow-y-auto rounded-lg border border-border bg-surface p-1 shadow-sm">
 ...
 rows={1}
 className="min-h-[40px] w-full resize-none rounded-lg border border-border bg-surface px-3 py-2.5 pr-20 text-sm ring-offset-surface placeholder:text-text-tertiary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 dark:text-dark-text-primary"
 />
