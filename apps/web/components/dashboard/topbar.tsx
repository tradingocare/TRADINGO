...
export function Topbar({ title }: TopbarProps) {
 ...
 return (
 <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-border bg-bg-elevated px-4 backdrop-blur sm:px-6">
 <div className="flex items-center gap-3 lg:hidden">
 <TradingoLogo height={32} showText={false} />
 </div>

 {title && (
 <h1 className="hidden text-lg font-semibold text-text-primary sm:block">
 {title}
 </h1>
 )}
 ...
 className="h-9 w-full rounded-lg border border-border bg-surface-secondary pl-10 pr-4 text-sm text-text-primary placeholder:text-text-tertiary focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
 />
 </form>
 </div>
 ...
 className="relative flex h-9 w-9 items-center justify-center rounded-lg text-text-secondary transition-colors hover:bg-surface-secondary"
 ...
 className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-text-secondary transition-colors hover:bg-surface-secondary"
 >
