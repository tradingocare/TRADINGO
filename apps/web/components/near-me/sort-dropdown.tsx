...
export function SortDropdown({ value, onChange }: SortDropdownProps) {
 ...
 className="h-10 appearance-none rounded-lg border border-border bg-surface pl-9 pr-8 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-accent"
 >
