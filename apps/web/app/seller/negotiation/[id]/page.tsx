...
import {
  useAiNegotiationStrategy, useAiBuyerBehavior, useAiSellerSuggestions,
...
export default function SellerNegotiationDetailPage() {
  ...
  const buyerBehaviorMutation = useAiBuyerBehavior();
  ...
  const isAiGenerating = stratMutation.isPending || buyerBehaviorMutation.isPending || sellerSuggestionsMutation.isPending || sentimentMutation.isPending || probabilityMutation.isPending || repliesMutation.isPending || riskMutation.isPending || summaryMutation.isPending || memoryMutation.isPending || aiTimelineMutation.isPending;
            ...
            <>
              <div className="rounded-xl border border-white/[0.06] bg-white/[0.04] p-5 backdrop-blur-xl">
                <AiNegotiationCopilot
                  ...
                  onBuyerBehavior={(d) => handleAiAction('Buyer Behavior', buyerBehaviorMutation, d)}
                  onSellerSuggestions={(d) => handleAiAction('Seller Suggestions', sellerSuggestionsMutation, d)}
