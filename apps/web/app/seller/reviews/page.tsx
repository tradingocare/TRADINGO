    ...
    <div className="min-h-screen pt-24 pb-16" style={{ background: 'var(--bg-base)' }}>
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-3">
          <div className="rounded-3xl p-6 bg-surface" style={{ backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.09)' }}>
        ...
        <div className="mt-8 space-y-4">
          ...
          {!error && reviews.length === 0 && <EmptyState icon={Star} title="No reviews yet" />}
          {reviews.map((review: any) => (
            <div key={review.id}
              className="rounded-3xl p-6 bg-surface"
              style={{ backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.09)' }}>
