...
import { Building2, Globe, Users, Briefcase, ListTree, FileText, Bell, Languages, DollarSign, Check } from 'lucide-react';
...
export default function OnboardingPage() {
 ...
 <Select className="pl-10" {...step1.register('companySize')}>
 ...
 className="w-full rounded-lg border border-border bg-surface px-10 py-2 text-sm text-text-primary ring-offset-surface placeholder:text-text-tertiary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
 ...
 <Switch {...step3.register('notifications')} />
 </div>
 ...
 <Select className="pl-10" {...step3.register('language')}>
 ...
 <Select className="pl-10" {...step3.register('currency')}>
