...
import { Search, FileText, ArrowRight, DollarSign, FileCheck, AlertCircle, Clock } from 'lucide-react';
...
export default function BuyerPoPage() {
  ...
  const tabs = [
    ...
    { label: 'Seller Accepted', value: 'SELLER_ACCEPTED' },
    { label: 'Locked', value: 'LOCKED' },
  ];

  return (
    <div className="space-y-6">
      <DashboardPageHeader title="My Purchase Orders" description="Manage purchase orders generated from accepted negotiations" />
          ...
          {list.map((po: any) => (
            <div key={po.id} className="grid grid-cols-1 gap-3 border-b border-white/[0.06] px-6 py-4 last:border-0 lg:grid-cols-12 lg:items-center hover:bg-white/[0.02] cursor-pointer"
              ...
              <div className="lg:col-span-2">
                <Button variant="outline" size="sm" onClick={(e) => { e.stopPropagation(); router.push(`/buyer/po/${po.id}`); }}>
