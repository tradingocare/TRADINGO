    ...
    <div className="space-y-6">
      ...
      {orders.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-surface p-12 dark:bg-dark-surface dark:border-dark-border">
          ...
          <p className="mt-1 text-sm text-text-secondary dark:text-dark-text-secondary">Your orders will appear here once you accept a quote and start a purchase.</p>
        </div>
      ) : (
        <div className="rounded-xl border border-border bg-surface dark:bg-dark-surface dark:border-dark-border">
          ...
          {orders.map((order: Order) => (
            ...
            >
              ...
              <p className="text-sm text-text-primary dark:text-dark-text-primary sm:col-span-3">{order.productName}</p>
