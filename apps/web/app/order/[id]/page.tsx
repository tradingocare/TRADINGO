...
async function OrderContent({ id }: { id: string }) {
 ...
 />
 <div>
 <p className={`font-medium ${isActive ? 'text-text-primary' : 'text-text-secondary'}`}>
 {step.label}
 </p>
 ...
 <span className="flex items-center gap-1 text-lg font-bold text-text-primary">
 ...
 <span className="font-medium text-text-primary">{updatedDate}</span>
 </div>
 </CardContent>
 </Card>
 </div>
