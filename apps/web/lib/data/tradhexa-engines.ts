...
export const engines: EngineData[] = [
  ...
  },
  {
    id: 'tradzero',
    name: 'TRADZERO',
    tagline: 'Zero-Commission Transaction Engine',
    icon: CreditCard,
    description: 'TRADINGO earns only from subscription plans. Zero commission and zero platform fees from any buyer or seller — on every transaction. Escrow protection, milestone payments, and dispute resolution — all included free.',
    purpose: 'TRADZERO is the zero-fee trading engine. TRADINGO never charges commission or platform fees from buyers or sellers — the platform earns only through its subscription plans. Escrow protection, milestone releases, and fair dispute resolution keep every deal risk-free. Sellers keep 100% of their margin, buyers pay exactly the agreed price.',
    features: [
      'Zero commission from buyers or sellers — ever',
      'Platform earns only from subscription plans',
      'Zero platform fees — no hidden charges',
      'Sellers keep 100% of their margin',
      'Free escrow protection included',
      'Milestone-based payment release for large orders',
      'Structured dispute management and resolution',
    ],
    buyerBenefits: [
      'Pay only the agreed price — no extra fees, ever',
      'Get full refund protection for failed deliveries',
      'Milestone payments for large or complex orders',
      'Escrow-backed safety with zero additional cost',
    ],
    sellerBenefits: [
      'Keep 100% of your sale — zero commission',
    ...
    useCases: [
      'A buyer places a $50,000 order paying zero commission — only the agreed price',
      'A seller ships goods confidently knowing every rupee of the sale is theirs',
      'A dispute over product quality is resolved through structured mediation — free of charge',
    ],
    faqs: [
      { q: 'Does TRADINGO charge any commission?', a: 'No. TRADINGO never charges commission or platform fees from any buyer or seller. The platform earns only from its subscription plans. The price you agree is the price you pay.' },
      { q: 'Is escrow protection free?', a: 'Escrow protection is included free for all transactions on TRADINGO. No additional fees — ever.' },
